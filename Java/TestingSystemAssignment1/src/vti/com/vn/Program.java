...
//		Account
		...
		question1.id = 1;
		question1.content = " Conten 1";
		question1.categoryQuestion = cat1;
		question1.typeQuestion = type1;
		question1.creatorID = account1;
		question1.createDate = date1;
		
		Question question2 = new Question();
		question2.id = 2;
		question2.content = " Conten 2";
		question2.categoryQuestion = cat1;
		question2.typeQuestion = type1;
		question2.creatorID = account1;
		question2.createDate = date1;
		
		Question question3 = new Question();
		question3.id = 2;
		question3.content = " Conten 2";
		question3.categoryQuestion = cat1;
		question3.typeQuestion = type2;
		question3.creatorID = account2;
		question3.createDate = date2;
